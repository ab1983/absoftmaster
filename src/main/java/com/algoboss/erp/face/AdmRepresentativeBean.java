...
import com.algoboss.erp.dao.RepresentativeDao;
import com.algoboss.erp.entity.AdmRepresentative;
import com.algoboss.erp.entity.GerBankAccount.AccountType;
...
public class AdmRepresentativeBean extends GenericBean<AdmRepresentative> {
    ...
    public AdmRepresentativeBean() {
        super.url = "views/administration/representative/representativeList.xhtml";
