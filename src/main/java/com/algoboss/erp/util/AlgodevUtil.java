...
public class AlgodevUtil {
    ...
    public static DevEntityClass arrayToEntity(Object[] strArray, DevEntityClass entity) {
        ...
        for (int i = 0; i < strArray.length; i++) {
            ...
            /*
            propType = getPreffixCmd(string);
            if (string.startsWith("_")) {
                propType = "STRING";
                string = string.replace("_", "");
                config.setConfigName("length");
                config.setConfigValue("long");
                configList.add(config);
                ...
                propType = "DATE";
                string = string.replace("@", "");
                config.setConfigName("pattern");
                config.setConfigValue("HH:mm");
                configList.add(config);
            } else if (string.startsWith("!")) {
                propType = "BOOLEAN";
                string = string.replace("!", "");
                ...
                propType = "ONEINTERNALOBJECT";
                string = string.replace(")", "");
            } else if (string.startsWith("))")) {
                propType = "ENTITYCHILDREN";
                string = string.replace("))", "");
            } else if (string.startsWith("(")) {
                propType = "ENTITYCLASS";
                string = string.replace("(", "");
            } else if (string.startsWith("((")) {
                propType = "MANYEXTERNALOBJECT";
                string = string.replace("((", "");
            }
            */
