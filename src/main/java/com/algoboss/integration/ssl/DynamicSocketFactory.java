package com.algoboss.integration.ssl;
...
public class DynamicSocketFactory implements ProtocolSocketFactory {
	private SSLContext ssl = null;
	private X509Certificate certificate;
	private PrivateKey privateKey;
	private String fileCacerts;

	public DynamicSocketFactory(X509Certificate certificate,
	...
	public static void generateSslByNFeConfig(final NFeConfig config){
		try {

	        /**
	         * Informações do Certificado Digital A3.
	         */
	        String caminhoDoCertificadoDoCliente = config.getCertificado().getAbsolutePath();
	        String senhaDoCertificado = config.getCertificadoSenha();
	        String arquivoCacertsGeradoTodosOsEstados = config.getCadeiaCertificados().getAbsolutePath();
	        ...
	        */
			...
			DynamicSocketFactory socketFactoryDinamico = new DynamicSocketFactory(certificate, privateKey);
